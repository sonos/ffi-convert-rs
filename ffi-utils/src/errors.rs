...
/// generate_error_handling!(get_error_symbol_name);
/// ```
///
...
///                          my_wrap            // name of the wrap macro
/// );
///
/// ```
///
...
macro_rules! generate_error_handling {
    ...
    ($get_error_symbol:ident, $error_type_name:ident, $error_ok:ident, $error_ko:ident, $error_stderr_envvar:expr, $wrap_name:ident) => {
...
#[cfg(test)]
mod tests2 {
    generate_error_handling!(get_last_error2, MY_RESULT_TYPE, MY_RESULT_TYPE_OK, MY_RESULT_TYPE_KO, "MY_ERROR_STDERR", mywrap);
